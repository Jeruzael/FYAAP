...
/*var a = event.keyCode;
	...
	if ( document.documentElement.scrollTop > 50) {
      ...
      document.getElementById("content").style.marginLeft = "75px";
   		...
   		document.getElementById("cover1").style.marginTop = "0px";
   		document.getElementById("t1").style.fontSize = "70px";
   		document.getElementById("cover1").style.transition = "1s";
   		document.getElementById("t1").style.bottom = "20px";
   		document.getElementById("navBar1").style.marginTop = "-1460px";
    	document.getElementById("navBar1").style.marginLeft = "1040px";
    	document.getElementById("img01").style.opacity = ".9";
    	document.getElementById("img01").style.marginTop = "0px";
    	document.getElementById("cover1").style.boxShadow = "1px 3px 7px rgba(130,130,130,.0)";
    	document.getElementById("cover1").style.backgroundColor = "rgba(230,230,230,.0)";
    	document.getElementById("content").style.display = "none";
      document.getElementById("nav2").style.marginLeft = "-270px";
  }
